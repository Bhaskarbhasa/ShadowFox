...
MODEL_PATH = os.path.join(BASE_DIR, "model", "boston_model.pkl")
...
set_bg("D:\Shadow fox intern\Boston_house_price_prediction\premium_photo-1701590725721-add548ecdf61.jpg")  # raw string
